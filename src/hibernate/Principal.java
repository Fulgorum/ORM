...
public class Principal {
    ...
    private static void menu() throws IOException {
        ...
        do {
            ...
            System.out.println("5. Consultar SQL.");
            System.out.println("6. Salir");
            respuesta = br.readLine();

            boolean b = respuesta.equals("1") || respuesta.equals("2") || respuesta.equals("3") || respuesta.equals("4") || respuesta.equals("5");
            if (b) {
            ...
            switch (respuesta) {
                ...
                case "5" -> consultaHQL(session);
                default -> {
                    if (!respuesta.equals("6")) System.out.println("la respuesta debe ser 1, 2, 3, 4, 5 ó 6");
                }
    ...
    private static void consultaHQL(Session session) {
        List<Profesor> profesors = session.createQuery("from Profesor", Profesor.class).list();
    ...
    private static void menuInsertar(Session session) throws IOException {
        ...
        do {
            System.out.println("Selecciona que elemento desea insertar: 1 2 3");
            System.out.println("1. Insertar profesor");
            System.out.println("2. Insertar asignaturas");
            System.out.println("3. Insertar correos electronicos");
            ...
            switch (respuesta) {
                ...
                default -> {
                    if (!respuesta.equals("4")) {
                        System.out.println("La respuesta tiene que ser 1 2 3 o 4");
                    } else {
                        salir = true;
                    }
                }
    ...
    private static int verProfesor(Session session) throws IOException {
        ...
        if (profesor == null) {
            System.out.println("No hay ningún profesor asociado al id que buscas.");
            return 0;
        }
        System.out.println(profesor);
